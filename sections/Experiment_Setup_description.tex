...
\begin{figure}[H]
	...
	\caption{Mesuring the rotor winding parameters}
\end{figure}
...
\section{\textbf{Chrono Brushed Electric Motor \& Dyno Testbed Models}}
\begin{itemize}
...
\begin{itemize}
    ...
    \item \textbf{Rotor and Rotor\_winding Model:}
    \begin{figure}[H]
        \centering
        \includegraphics[width=0.90\textwidth]{images/Screenshot From 2025-03-26 04-26-15.png}
    \end{figure}
\end{itemize}
...
\begin{itemize}
    ...
    \needspace{10\baselineskip}
	\item \textbf{Constant load torque application (Duty Coycle = 100\%)} 
        \begin{figure}[H]
        	\centering
