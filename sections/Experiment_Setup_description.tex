...
Mass of the Rotor: 8.5 grams \\
Rotor Geometric Inertia: \\
Ixx = 16081.3   \\
Iyy = 16081.30  \\
Izz = 520.48    \\
\end{itemize}
...
\begin{itemize}
	...
	\item \textbf{Different rpm levels in response to the PWM input} 
        \begin{figure}[H]
        	\centering
        	\includegraphics[width=1.0\textwidth]{images/Screenshot From 2025-03-26 03-20-22.png}
        \end{figure}
	...
	\item \textbf{The contribution of the Kt (Nm/A)} 
        \begin{figure}[H]
        	\centering
        	\includegraphics[width=1.0\textwidth]{images/Screenshot From 2025-03-26 03-36-38.png}
        \end{figure}
